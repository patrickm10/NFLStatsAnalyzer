...
def on_qb_player_click(event):
    ...
    if selected_item:
        ...
        stats_file = f"qb_weekly_stats/{player_name.replace(' ', '_').lower()}_weekly_stats.csv"
...
def on_rb_player_click(event):
    ...
    if selected_item:
        ...
        # Create the path to the player's weekly stats file
        stats_file = f"rb_weekly_stats/{player_name.replace(' ', '_').lower()}_weekly_stats.csv"
...
def on_wr_player_click(event):
    ...
    if selected_item:
        ...
        # Create the path to the player's weekly stats file
        stats_file = f"wr_weekly_stats/{player_name.replace(' ', '_').lower()}_weekly_stats.csv"
...
def on_kicker_player_click(event):
    ...
    if selected_item:
        ...
        # Create the path to the player's weekly stats file
        stats_file = f"kicker_weekly_stats/{player_name.replace(' ', '_').lower()}_weekly_stats.csv"
